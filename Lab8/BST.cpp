...
//to get the maxmimum, just keep going right because right is always > left 
...
//this just keeps going left to get the minimum 
...
Node* BST::deleteNode(Node *currNode, int value)
{
  ...
  else
  {
    ...
    //TODO Case 4: Both left and right child
    else
    {
        //Replace with Minimum from right subtree --> 
        //call getMinValueNode(currNode-> right) because you want the minimum from the right subtree 
        //make the currNode->value= minValueNode-> value so swapping the values
        //then 
